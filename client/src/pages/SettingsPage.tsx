...
import type { SmtpServer, AppConfig, AgentGlobalConfig, NotificationTypeConfig, ObligateConfig } from '@oblimap/shared';
        ...
        <>
          ...
          <div>
            ...
            <div className="rounded-lg border border-border bg-bg-secondary p-5 space-y-4">
              <p className="text-sm text-text-muted">
                Connect Oblimap to your Obligate SSO gateway for centralized authentication and cross-app navigation.
